            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="text-2xl p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid relative flex items-center justify-center row-start-1 col-start-1 col-end-2">
                        <form class="w-full max-w-lg" method="POST" action=" {{ route('session.store') }} ">
                            @csrf
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <div class="w-full md:w-2/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="appearance-none block w-full bg-white-100 text-gray-700 border border-gray-400 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" name="playlist_name" type="text" placeholder="Example name">
                                </div>
                            </div>
